...
@recipient_access_router.get("", summary="Get a recipient's assigned caregivers")
...
@recipient_access_router.post("", summary="Assign caregiver to a recipient")
...
@recipient_invitations_router.get("", summary="Get a recipient's received invitations")
async def list_recipient_invitations(recipientId: str) -> Dict[str, Any]:
    return {"recipientId": recipientId, "items": []}


@recipient_invitations_router.post("/{invitationId}/accept", summary="Recipient accepts a caregiver invitation")
async def accept_invitation(recipientId: str, invitationId: str) -> Dict[str, Any]:
    return {"message": "invitation accepted", "recipientId": recipientId, "invitationId": invitationId}


@recipient_invitations_router.post("/{invitationId}/decline", summary="Recipient declines a caregiver invitation")
async def decline_invitation(recipientId: str, invitationId: str) -> Dict[str, Any]:
    return {"message": "invitation declined", "recipientId": recipientId, "invitationId": invitationId}


@recipient_invitations_router.get("/{invitationId}", summary="Get recipient invitation details")
